const Contact = () => {
    return (
        <footer className="mt-10 bg-gradient-to-r from-lightBeige to-white text-lightBlue py-6 lg:px-20 md:px-20 px-4 text-center shadow-lg border-t-2 border-beige space-y-10">
            <div className="flex self-start text-brown font-raleway lg:text-3xl text-2xl font-medium">contact info</div>
            <div className="flex flex-row justify-between lg:mx-20 font-raleway text-darkBrown lg:text-lg text-base h-full items-end">
